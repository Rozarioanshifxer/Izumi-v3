...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "izumi~dMQBui75",
  ...
  OWNER_NAME: process.env.OWNER_NAME || " ᴀɴsʜɪғ xᴇʀ",
  BOT_NAME: process.env.BOT_NAME || " ᴀɴsʜɪғ xᴇʀ-𝚅3",
  SUDO: process.env.SUDO || null,
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || " ᴀɴsʜɪғ xᴇʀ-v3,❤️",
  AUDIO_DATA: process.env.AUDIO_DATA || " ᴀɴsʜɪғ xᴇʀ; ᴀɴsʜɪғ xᴇʀ;https://i.imgur.com/cO0TZJv.jpeg",
  PROCESSNAME: process.env.PROCESSNAME || "Izumi-v3",
  AUTHOR: process.env.AUTHOR || " ᴀɴsʜɪғ xᴇʀ",
